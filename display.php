...
left JOIN  employees ON employees.emp_id = project_create.owner
            ...
            <table id="myTable" class="table table-striped table-bordered display responsive nowrap  ">
                <thead class="table-dark text-center">
                    <tr class="text-center">
                        ...
                        <th class="text-center" scope="col-1">ดูรายละเอียดโปรเจค</th>
                ...
                <tbody class="text-break">
                    ...
                    while ($task = mysqli_fetch_assoc($result_task)) {  ?>
                        <tr>
                            ...
                            <td> <a href="mainpage.php?idp=<?php echo $task['project_id'] ?>" class="btn btn-info"><i class="bi bi-info-circle-fill"></i> ดูรายละเอียด</a>
                        </td>
                            <td><?php echo $task['emp_fname'] . " " . $task['emp_lname'] ?></td>

                            <td scope="col"><?php echo $task['detail'] ?></td>
