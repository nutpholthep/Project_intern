...
$sql = "SELECT p.project_id,p.project_name,p.create_time,p.dead_line,p.update_time,p.create_by,p.update_by,p.detail,p.team_member,
            ...
            <form action="edit_mainPage.php" method="post">
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    ...
                    <div class="input-group mt-3">
                        ...
                        <input type="text" name="Owner_fname" class="form-control" placeholder="ป้อนชื่อ" readonly value="<?php echo $row['emp_fname'] ?>">
                        <input type="text" name="Owner_lname" class="form-control" placeholder="ป้อนนามสกุล" readonly value="<?php echo $row['emp_lname'] ?>">
                    ...
                    <tbody>
                        <?php while ($task = mysqli_fetch_assoc($result_task)) { ?>
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-outline-info open_update" data-bs-toggle="modal" idx="<?php echo $task['activity_id'] ?>" data-bs-target="#add_update">
                                        อัปเดตความคืบหน้า
                                ...
                                <td><?php echo $task['activity_name']; ?> <sup><a href="#" class="open_edit_activity" data-bs-target="#edit_activity" data-bs-toggle="modal" idx="<?php echo $task['activity_id']; ?>"><i class="bi bi-pencil-square text-warning"></i></a></sup></td>
